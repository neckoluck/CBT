...
class AuthAdministrator extends BaseController
{
    protected $loginMod;
    ...
    public function index()
    {
        $data = [
            ...
            'action'     => base_url() . '/auth/administrator/login',
    ...
    public function login()
    {
        ...
        if ($this->valid->run($data, 'login1') !== false) :
            ...
            if (is_array($result)) :
                ...
                return redirect()->to('/auth/administrator')->withInput()->with('validation', $this->valid->getErrors());
