     ...
     <div class="card mb-0 shadow-0">
         <div class="card-body">
             ...
             <div class="form-group form-group-feedback form-group-feedback-left mb-4">
                 <input type="text" class="form-control text-uppercase" autocomplete="off" placeholder="Contoh: 00-025-009**" maxlength='16' name="username" id="username" value="<?= old('username'); ?>" />
             ...
             <div class="form-group form-group-feedback form-group-feedback-left mb-4">
                 <input type="password" class="form-control show-password" autocomplete="off" placeholder="Contoh: 00919148**" name="password" value="<?= old('password'); ?>" />
                 <div class="form-control-feedback">
             ...
             <div class="form-group form-group-feedback form-group-feedback-left mb-4">
                 <input type="password" class="form-control show-password" autocomplete="off" placeholder="Contoh: 00919148**" name="cpassword" value="<?= old('cpassword'); ?>" />
                 <div class="form-control-feedback">
                     <i class="icon-user-lock text-muted"></i>
                 </div>
