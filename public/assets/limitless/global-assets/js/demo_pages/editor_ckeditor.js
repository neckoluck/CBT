...
var CKEditor = function() {
    ...
    var _componentCKEditor = function() {
        ...
        */ 
        ...
        // ------------------------------
        // Setup
        CKEDITOR.replace('editor-full-a', {
            height: 100,
            removePlugins: "dialogui,dialog,a11yhelp,about,bidi,blockquote,pbckcode," +
            "button,panelbutton,panel,floatpanel,colorbutton,colordialog,menu," +
            "contextmenu,dialogadvtab,div,enterkey,entities,popup," +
            "filebrowser,find,fakeobjects,flash,floatingspace,listblock,richcombo," +
            "font,format,forms,horizontalrule,htmlwriter,iframe,image,indent," +
            "indentblock,indentlist,justify,link,liststyle,magicline," +
            "maximize,newpage,pagebreak,pastefromword,pastetext,preview,print," +
            "removeformat,resize,save,menubutton,scayt,selectall,showblocks," +
            "smiley,specialchar,stylescombo,tab,table," +
            "tabletools,wsc"
        });

        CKEDITOR.replace('editor-full-b', {
            height: 100,
            removePlugins: "dialogui,dialog,a11yhelp,about,bidi,blockquote,pbckcode," +
            "button,panelbutton,panel,floatpanel,colorbutton,colordialog,menu," +
            "contextmenu,dialogadvtab,div,enterkey,entities,popup," +
